...
const Auction = () => {
  ...
  const initializeTimer = (auctionData) => {
 ...
 const declareWinner = async (winningBid) => {
    console.log(`In declareWinner:`);
    console.log(`winningBid: ${winningBid}`);
    console.log(`winningBid: ${JSON.stringify(winningBid)}`);
    ...
    if (currentUserId?.toString() === winningBid.userId?.toString()) {
        ...
        console.error('Failed to close auction:', error.message);
        }
    }
